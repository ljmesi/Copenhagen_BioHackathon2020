...
for link in links:                     #For each of the links nodes
    ...
    Categories_list = []
    Categories = browser.find_elements_by_xpath("//ul[@class = 'normal-list']//a[@class = 'normal-link']")      #Syntax used to identify the different links of categoreis that thee may appear 
